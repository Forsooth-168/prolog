build_list:-read_list(List1), read_list(List2), filter(List1, ResList1), filter(List2, ResList2), main(ResList1, ResList2, Result1), main(ResList2, ResList1, Result2), append(Result1, Result2, List), write(List).
